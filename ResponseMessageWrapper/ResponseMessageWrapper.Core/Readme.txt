# ResponseMessageWrapper.Core 

The ResponseMessageWrapper.Core is a global exception handler and response wrapper for ASP.NET Core APIs. It uses a middleware to capture exceptions and to capture HTTP response to build a consistent response object for both successful and error requests.
...
Below are the steps to use the ResponseMessageWrapper.Core middleware into your ASP.NET Core app:
